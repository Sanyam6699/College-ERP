...
const Login = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: `url("https://images.unsplash.com/photo-1592930954854-7d00c87d0cf4?auto=format&fit=crop&q=80&w=2070&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")`,
      ...
      <div className="flex flex-col items-center mt-10 space-y-32">
        ...
        <div className="grid grid-cols-2 gap-28">
          <div className="h-96 w-96 space-y-11 shadow-2xl flex flex-col justify-center items-center bg-transparent backdrop-blur-md bg-[green] bg-opacity-50 rounded-xl">
          ...
          <div className="h-96 w-96 space-y-11 shadow-2xl flex flex-col justify-center items-center bg-transparent backdrop-blur-md bg-[violet] bg-opacity-50 rounded-xl">
